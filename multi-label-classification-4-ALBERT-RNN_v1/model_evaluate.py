...
# 加载训练好的模型
model = load_model(
    "model/rinse/rgu/event_type.h5", custom_objects={"Attention": Attention}
)
with open("model/rinse/rgu/event_type.json", "r", encoding="utf-8") as f:
...
df.to_csv("model/rinse/rgu4_5/pred_result.csv", index=False)
